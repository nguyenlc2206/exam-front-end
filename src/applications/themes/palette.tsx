...
// assets
import defaultColor from '@package:src/assets/scss/_themes-vars.module.scss';
import theme1 from '@package:src/assets/scss/_theme1.module.scss';
import theme2 from '@package:src/assets/scss/_theme2.module.scss';
import theme3 from '@package:src/assets/scss/_theme3.module.scss';
import theme4 from '@package:src/assets/scss/_theme4.module.scss';
import theme5 from '@package:src/assets/scss/_theme5.module.scss';
import theme6 from '@package:src/assets/scss/_theme6.module.scss';

// types
import { ColorProps } from '@package:src/common/types';
